...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"alias","ip_address":"praesentium","latitude":"atque","longitude":"non"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"ut","latitude":"praesentium","longitude":"iure"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=quod&follow_up_type=sed&followup_category_id=hic&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=delectus&biz_name=velit&mobile_num=18&contact_id=illo&order_by=sunt&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"incidunt","mobile_name":"et","call_type":"call","start_time":"vel","end_time":"impedit","duration":"harum"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":0.375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":457,"total_card_slips":18,"total_cheques":15,"closing_note":"asperiores","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=eum&name=modi&biz_name=distinctio&mobile_num=18&contact_id=quam&order_by=facilis&direction=eaque&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"consequatur","prefix":"modi","first_name":"enim","middle_name":"doloribus","last_name":"nulla","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"et","address_line_2":"assumenda","city":"est","state":"totam","country":"cum","zip_code":"velit","customer_group_id":"vitae","contact_id":"voluptatem","dob":"2000-06-13","custom_field1":"eveniet","custom_field2":"voluptatem","custom_field3":"voluptatem","custom_field4":"id","email":"alias","shipping_address":"quia","position":"explicabo","opening_balance":0,"source_id":8,"life_stage_id":12,"assigned_to":[]}'
...
let body = {
    ...
    "dob": "2000-06-13",
    "custom_field1": "eveniet",
    "custom_field2": "voluptatem",
    "custom_field3": "voluptatem",
    "custom_field4": "id",
    "email": "alias",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"natus","prefix":"quo","first_name":"ex","middle_name":"molestiae","last_name":"voluptatem","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"at","address_line_2":"veritatis","city":"quidem","state":"illo","country":"odit","zip_code":"voluptas","customer_group_id":"suscipit","contact_id":"rem","dob":"2000-06-13","custom_field1":"reprehenderit","custom_field2":"quisquam","custom_field3":"nihil","custom_field4":"fuga","email":"dolore","shipping_address":"quis","position":"quo","opening_balance":10.3,"source_id":19,"life_stage_id":20,"assigned_to":[]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":18,"card_number":"nostrum","card_holder_name":"laudantium","card_transaction_number":"ab","card_type":"quia","card_month":"ex","card_year":"voluptatem","card_security":"voluptates","transaction_no_1":"rerum","transaction_no_2":"sunt","transaction_no_3":"soluta","cheque_number":"pariatur","bank_account_number":"molestias","note":"quibusdam"}'
...
let body = {
    ...
    "account_id": 18,
    "card_number": "nostrum",
    "card_holder_name": "laudantium",
    "card_transaction_number": "ab",
    "card_type": "quia",
    "card_month": "ex",
    "card_year": "voluptatem",
    "card_security": "voluptates",
    "transaction_no_1": "rerum",
    "transaction_no_2": "sunt",
    "transaction_no_3": "soluta",
    "cheque_number": "pariatur",
    "bank_account_number": "molestias",
    "note": "quibusdam"
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=eum&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":56.16256,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":18,"contact_id":10,"expense_category_id":6,"expense_sub_category_id":1,"additional_notes":"natus","is_refund":0,"is_recurring":0,"recur_interval":4,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"enim","recur_repetitions":6,"payment":[{"amount":453.13,"method":"cash","account_id":4,"card_number":"molestiae","card_holder_name":"perferendis","card_transaction_number":"atque","card_type":"est","card_month":"officiis","card_year":"accusantium","card_security":"nostrum","transaction_no_1":"voluptatum","transaction_no_2":"modi","transaction_no_3":"animi","note":"eum","cheque_number":"quis"}]}'
    ...
    "payment": [
        {
            ...
            "method": "cash",
            "account_id": 4,
            "card_number": "molestiae",
            "card_holder_name": "perferendis",
            "card_transaction_number": "atque",
            "card_type": "est",
            "card_month": "officiis",
            "card_year": "accusantium",
            "card_security": "nostrum",
            "transaction_no_1": "voluptatum",
            "transaction_no_2": "modi",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":24892901,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":8,"expense_for":8,"contact_id":16,"expense_category_id":3,"expense_sub_category_id":19,"additional_notes":"rerum","is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"doloribus","recur_repetitions":18,"payment":[]}'
...
let body = {
    ...
    "additional_notes": "rerum",
    "is_recurring": 0,
    "recur_interval": 20,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "doloribus",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=reiciendis&assigned_to=rerum&status=officiis&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":2,"visit_to":"iusto","visit_address":"sit","assigned_to":18,"visit_on":"2021-12-28 17:23:00","visit_for":"molestiae"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"eum","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"consequatur","photo":"dolorem","meet_with":"architecto","meet_with_mobileno":"et"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "eum",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=libero&order_direction=porro&brand_id=et&category_id=autem&sub_category_id=deserunt&location_id=1&selling_price_group=nobis&send_lot_detail=atque&name=soluta&sku=cumque&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "libero",
    "order_direction": "porro",
    "brand_id": "et",
    "category_id": "autem",
    "sub_category_id": "deserunt",
    "location_id": "1",
    "selling_price_group": "nobis",
    "send_lot_detail": "atque",
    "name": "soluta",
    "sku": "cumque",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=est&send_lot_detail=velit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=provident&location_id=1&brand_id=dicta&category_id=facere&sub_category_id=voluptate&not_for_selling=perspiciatis&name=ab&sku=perspiciatis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=consequatur&status=final&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=commodi&res_waiter_id=iste&shipping_status=ordered&source=enim&only_subscriptions=doloribus&send_purchase_details=neque&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":5,"transaction_date":"2020-07-22 15:48:29","invoice_no":"qui","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":15,"discount_amount":10,"discount_type":"fixed","sale_note":"et","staff_note":"ratione","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"sit","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":16,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"veniam","recur_repetitions":7,"rp_redeemed":14,"rp_redeemed_amount":13.5,"types_of_service_id":6,"service_custom_field_1":"voluptates","service_custom_field_2":"dolore","service_custom_field_3":"corrupti","service_custom_field_4":"odit","service_custom_field_5":"beatae","service_custom_field_6":"aut","round_off_amount":2840479.18258,"table_id":10,"res_waiter_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":20,"note":"delectus"}],"payments":[{"amount":453.13,"method":"cash","account_id":16,"card_number":"minus","card_holder_name":"alias","card_transaction_number":"rerum","card_type":"et","card_month":"velit","card_year":"sint","card_security":"animi","transaction_no_1":"fugit","transaction_no_2":"similique","transaction_no_3":"sit","bank_account_number":"earum","note":"fugiat","cheque_number":"est"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "voluptates",
            "service_custom_field_2": "dolore",
            "service_custom_field_3": "corrupti",
            "service_custom_field_4": "odit",
            "service_custom_field_5": "beatae",
            "service_custom_field_6": "aut",
            "round_off_amount": 2840479.18258,
            "table_id": 10,
            "res_waiter_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_year": "sint",
                    "card_security": "animi",
                    "transaction_no_1": "fugit",
                    "transaction_no_2": "similique",
                    "transaction_no_3": "sit",
                    "bank_account_number": "earum",
                    "note": "fugiat",
                    "cheque_number": "est"
                }
            ]
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=odit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":11,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":17,"discount_amount":10,"discount_type":"fixed","sale_note":"provident","source":"natus","staff_note":"et","is_suspend":false,"commission_agent":15,"shipping_details":"Express Delivery","shipping_address":"qui","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":17,"pay_term_type":"months","is_recurring":0,"recur_interval":18,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"voluptas","recur_repetitions":12,"rp_redeemed":7,"rp_redeemed_amount":13.5,"types_of_service_id":15,"service_custom_field_1":"aliquam","service_custom_field_2":"tempora","service_custom_field_3":"est","service_custom_field_4":"perferendis","service_custom_field_5":"repellat","service_custom_field_6":"laboriosam","round_off_amount":206090.5,"table_id":18,"res_waiter_id":18,"change_return":0,"change_return_id":16,"products":[{"sell_line_id":5,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":16,"discount_amount":0,"discount_type":"percentage","sub_unit_id":11,"note":"hic"}],"payments":[{"payment_id":17,"amount":453.13,"method":"cash","account_id":11,"card_number":"natus","card_holder_name":"magni","card_transaction_number":"nesciunt","card_type":"non","card_month":"commodi","card_year":"ut","card_security":"ut","transaction_no_1":"et","transaction_no_2":"facilis","transaction_no_3":"omnis","note":"maxime","cheque_number":"est","bank_account_number":"hic"}]}'
...
let body = {
    ...
    "service_custom_field_1": "aliquam",
    "service_custom_field_2": "tempora",
    "service_custom_field_3": "est",
    "service_custom_field_4": "perferendis",
    "service_custom_field_5": "repellat",
    "service_custom_field_6": "laboriosam",
    "round_off_amount": 206090.5,
    "table_id": 18,
    "res_waiter_id": 18,
    "change_return": 0,
    "change_return_id": 16,
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/beatae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":15,"transaction_date":"2020-5-7 15:20:22","invoice_no":"sint","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":11,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"ipsum"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=saepe" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"vitae","first_name":"ut","last_name":"non","email":"eum","is_active":"quo","user_type":"hic","crm_contact_id":3,"allow_login":true,"username":"qui","password":"sit","role":12,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"ad","max_sales_discount_percent":"quia","selected_contacts":true,"selected_contact_ids":[],"dob":"maiores","gender":"officia","marital_status":"modi","blood_group":"cumque","contact_number":"et","alt_number":"deleniti","family_number":"qui","fb_link":"et","twitter_link":"nisi","social_media_1":"natus","social_media_2":"qui","custom_field_1":"dolores","custom_field_2":"optio","custom_field_3":"laboriosam","custom_field_4":"ut","guardian_name":"sunt","id_proof_name":"fugiat","id_proof_number":"est","permanent_address":"quas","current_address":"illo","bank_details":[{"account_holder_name":"dolorum","account_number":"qui","bank_name":"sed","bank_code":"impedit","branch":"aliquid","tax_payer_id":"quos"}]}'
...
let body = {
    ...
    "fb_link": "et",
    "twitter_link": "nisi",
    "social_media_1": "natus",
    "social_media_2": "qui",
    "custom_field_1": "dolores",
    "custom_field_2": "optio",
    "custom_field_3": "laboriosam",
    "custom_field_4": "ut",
    "guardian_name": "sunt",
    "id_proof_name": "fugiat",
    "id_proof_number": "est",
    "permanent_address": "quas",
    "current_address": "illo",
    "bank_details": [
        {
            "account_holder_name": "dolorum",
            "account_number": "qui",
            "bank_name": "sed",
            "bank_code": "impedit",
            "branch": "aliquid",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"doloribus","new_password":"labore"}'

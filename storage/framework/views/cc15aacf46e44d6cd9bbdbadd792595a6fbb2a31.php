...
<div class="row">
  <div class="col-md-12">
    <hr>
    <h3><?php echo app('translator')->getFromJson('lang_v1.product_sold_details_register'); ?> (<?php echo app('translator')->getFromJson('lang_v1.by_brand'); ?>)</h3>
    <table class="table table-condensed">
      <tr>
        <th>#</th>
...
<?php endif; ?><?php /**PATH /Users/mohan/projects/mohan/laravel/cocoa/resources/views/cash_register/register_product_details.blade.php ENDPATH**/ ?>
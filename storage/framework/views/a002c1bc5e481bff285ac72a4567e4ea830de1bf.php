		...
		<div class="col-md-12 col-sm-12">
			<?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
				...
				<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
					<div class="form-group">
						...
						<small class="text-danger hide contact_due_text"><strong><?php echo app('translator')->getFromJson('account.customer_due'); ?>:</strong> <span></span></small>
					</div>
					<small>
					<strong>
				...
				<?php else: ?>
					<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
						<div class="form-group">
							...
							<?php echo Form::select('status', $statuses, 'final', ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']);; ?>
			...
			<div class="col-md-4">
				<div class="form-group">
		            ...
		            <?php echo Form::select('shipping_status',$shipping_statuses, 'ordered', ['class' => 'form-control','placeholder' => __('messages.please_select')]);; ?>
	        ...
	        <?php if(!empty($shipping_custom_label_1)): ?>
	        	...
	        	<div class="col-md-4">
			        <div class="form-group">
			            ...
			            <?php echo Form::date('shipping_custom_field_1', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1'] : null, ['class' => 'form-control','placeholder' => $shipping_custom_label_1, 'required' => $is_shipping_custom_field_1_required]);; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohan/projects/mohan/laravel/cocoa/resources/views/sell/create.blade.php ENDPATH**/ ?>
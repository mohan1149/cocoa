	...
	<div class="col-sm-12">
		...
		<div class="col-sm-12 col-sm-offset-4">
			...
			<div class="col-sm-4">
				...
				<?php echo Form::text('selling_price', number_format(0, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input-sm input_number mousetrap']); ?>


				<?php echo Form::hidden('selling_price_inc_tax', number_format(0, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'input_number mousetrap', 'id' => 'selling_price_inc_tax']); ?>
...
</script><?php /**PATH /Users/mohan/projects/mohan/laravel/cocoa/resources/views/product/partials/combo_product_form_part.blade.php ENDPATH**/ ?>
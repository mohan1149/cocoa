...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"recusandae","ip_address":"consequatur","latitude":"placeat","longitude":"rerum"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"enim","latitude":"et","longitude":"ab"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=numquam&follow_up_type=distinctio&followup_category_id=eum&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "end_date": "2020-12-16",
    "status": "numquam",
    "follow_up_type": "distinctio",
    "followup_category_id": "eum",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"est","schedule_type":"qui","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=autem&biz_name=molestias&mobile_num=10&contact_id=quis&order_by=hic&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"dicta","mobile_name":"placeat","call_type":"call","start_time":"eaque","end_time":"quis","duration":"adipisci"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":172.063,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":2757632.9727,"total_card_slips":5,"total_cheques":1,"closing_note":"et","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=eos&name=non&biz_name=vel&mobile_num=17&contact_id=et&order_by=itaque&direction=blanditiis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"ut","prefix":"dolor","first_name":"velit","middle_name":"sit","last_name":"consequatur","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"numquam","address_line_2":"velit","city":"qui","state":"adipisci","country":"eum","zip_code":"optio","customer_group_id":"distinctio","contact_id":"sed","dob":"2000-06-13","custom_field1":"veniam","custom_field2":"et","custom_field3":"dolor","custom_field4":"voluptas","email":"quos","shipping_address":"optio","position":"ratione","opening_balance":0,"source_id":11,"life_stage_id":16,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "numquam",
    "address_line_2": "velit",
    "city": "qui",
    "state": "adipisci",
    "country": "eum",
    "zip_code": "optio",
    "customer_group_id": "distinctio",
    "contact_id": "sed",
    "dob": "2000-06-13",
    "custom_field1": "veniam",
    "custom_field2": "et",
    "custom_field3": "dolor",
    "custom_field4": "voluptas",
    "email": "quos",
    "shipping_address": "optio",
    "position": "ratione",
    "opening_balance": 0,
    "source_id": 11,
    "life_stage_id": 16,
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"quae","prefix":"aut","first_name":"maxime","middle_name":"hic","last_name":"amet","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"minus","address_line_2":"reiciendis","city":"et","state":"et","country":"sunt","zip_code":"autem","customer_group_id":"beatae","contact_id":"dolor","dob":"2000-06-13","custom_field1":"rerum","custom_field2":"aut","custom_field3":"dolor","custom_field4":"molestiae","email":"esse","shipping_address":"eaque","position":"voluptatibus","opening_balance":10.3,"source_id":16,"life_stage_id":2,"assigned_to":[]}'
...
let body = {
    ...
    "country": "sunt",
    "zip_code": "autem",
    "customer_group_id": "beatae",
    "contact_id": "dolor",
    "dob": "2000-06-13",
    "custom_field1": "rerum",
    "custom_field2": "aut",
    "custom_field3": "dolor",
    "custom_field4": "molestiae",
    "email": "esse",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":4,"card_number":"autem","card_holder_name":"repudiandae","card_transaction_number":"qui","card_type":"qui","card_month":"et","card_year":"voluptas","card_security":"et","transaction_no_1":"impedit","transaction_no_2":"voluptas","transaction_no_3":"quisquam","cheque_number":"qui","bank_account_number":"nulla","note":"eligendi"}'
...
let body = {
    ...
    "transaction_no_2": "voluptas",
    "transaction_no_3": "quisquam",
    "cheque_number": "qui",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=reprehenderit&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":18018,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":16,"expense_for":18,"contact_id":6,"expense_category_id":17,"expense_sub_category_id":17,"additional_notes":"ratione","is_refund":0,"is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"enim","recur_repetitions":10,"payment":[{"amount":453.13,"method":"cash","account_id":19,"card_number":"eos","card_holder_name":"odit","card_transaction_number":"sunt","card_type":"ut","card_month":"porro","card_year":"omnis","card_security":"eveniet","transaction_no_1":"error","transaction_no_2":"laboriosam","transaction_no_3":"et","note":"non","cheque_number":"ut"}]}'
...
let body = {
    ...
    "expense_sub_category_id": 17,
    "additional_notes": "ratione",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 5,
    ...
    "payment": [
        {
            ...
            "card_month": "porro",
            "card_year": "omnis",
            "card_security": "eveniet",
            "transaction_no_1": "error",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":72.158353983,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":11,"expense_for":14,"contact_id":12,"expense_category_id":18,"expense_sub_category_id":15,"additional_notes":"sit","is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quos","recur_repetitions":20,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=dignissimos&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=autem&assigned_to=est&status=sit&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":12,"visit_to":"sed","visit_address":"aperiam","assigned_to":1,"visit_on":"2021-12-28 17:23:00","visit_for":"asperiores"}'
...
let body = {
    "contact_id": 12,
    "visit_to": "sed",
    "visit_address": "aperiam",
    "assigned_to": 1,
    "visit_on": "2021-12-28 17:23:00",
    "visit_for": "asperiores"
}
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"qui","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"laboriosam","photo":"in","meet_with":"quia","meet_with_mobileno":"iure"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "qui",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=libero&order_direction=consequatur&brand_id=autem&category_id=occaecati&sub_category_id=dolor&location_id=1&selling_price_group=eaque&send_lot_detail=et&name=dolores&sku=qui&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "brand_id": "autem",
    "category_id": "occaecati",
    "sub_category_id": "dolor",
    "location_id": "1",
    "selling_price_group": "eaque",
    "send_lot_detail": "et",
    "name": "dolores",
    "sku": "qui",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=facere&send_lot_detail=aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=nihil&location_id=1&brand_id=assumenda&category_id=nihil&sub_category_id=laudantium&not_for_selling=exercitationem&name=aspernatur&sku=quidem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "not_for_selling": "exercitationem",
    "name": "aspernatur",
    "sku": "quidem",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=molestias&status=final&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=veniam&res_waiter_id=doloremque&shipping_status=ordered&source=harum&only_subscriptions=molestias&send_purchase_details=neque&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "location_id": "1",
    "contact_id": "molestias",
    "status": "final",
    "payment_status": "due,partial",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "user_id": "veniam",
    "res_waiter_id": "doloremque",
    "shipping_status": "ordered",
    "source": "harum",
    "only_subscriptions": "molestias",
    "send_purchase_details": "neque",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"ipsa","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":17,"discount_amount":10,"discount_type":"fixed","sale_note":"nihil","staff_note":"est","commission_agent":15,"shipping_details":"Express Delivery","shipping_address":"deserunt","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":6,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":7,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"architecto","recur_repetitions":13,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":3,"service_custom_field_1":"incidunt","service_custom_field_2":"eos","service_custom_field_3":"quaerat","service_custom_field_4":"fuga","service_custom_field_5":"unde","service_custom_field_6":"consectetur","round_off_amount":1.8347667,"table_id":5,"res_waiter_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":8,"note":"ratione"}],"payments":[{"amount":453.13,"method":"cash","account_id":3,"card_number":"rerum","card_holder_name":"vitae","card_transaction_number":"distinctio","card_type":"cumque","card_month":"ullam","card_year":"perferendis","card_security":"aspernatur","transaction_no_1":"optio","transaction_no_2":"impedit","transaction_no_3":"possimus","bank_account_number":"molestiae","note":"ex","cheque_number":"harum"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "incidunt",
            "service_custom_field_2": "eos",
            "service_custom_field_3": "quaerat",
            "service_custom_field_4": "fuga",
            "service_custom_field_5": "unde",
            "service_custom_field_6": "consectetur",
            "round_off_amount": 1.8347667,
            "table_id": 5,
            "res_waiter_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 3,
                    "card_number": "rerum",
                    "card_holder_name": "vitae",
                    "card_transaction_number": "distinctio",
                    "card_type": "cumque",
                    "card_month": "ullam",
                    "card_year": "perferendis",
                    "card_security": "aspernatur",
                    "transaction_no_1": "optio",
                    "transaction_no_2": "impedit",
                    "transaction_no_3": "possimus",
                    "bank_account_number": "molestiae",
                    "note": "ex",
                    "cheque_number": "harum"
                }
            ]
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=vel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":3,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"molestias","source":"minus","staff_note":"nemo","is_suspend":false,"commission_agent":2,"shipping_details":"Express Delivery","shipping_address":"impedit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":2,"pay_term_number":4,"pay_term_type":"months","is_recurring":0,"recur_interval":17,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"rerum","recur_repetitions":17,"rp_redeemed":10,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"deserunt","service_custom_field_2":"qui","service_custom_field_3":"animi","service_custom_field_4":"laboriosam","service_custom_field_5":"consequatur","service_custom_field_6":"porro","round_off_amount":62962665.059,"table_id":1,"res_waiter_id":7,"change_return":0,"change_return_id":16,"products":[{"sell_line_id":8,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":4,"discount_amount":0,"discount_type":"percentage","sub_unit_id":3,"note":"aut"}],"payments":[{"payment_id":7,"amount":453.13,"method":"cash","account_id":8,"card_number":"sed","card_holder_name":"ratione","card_transaction_number":"esse","card_type":"culpa","card_month":"quos","card_year":"et","card_security":"id","transaction_no_1":"eum","transaction_no_2":"aut","transaction_no_3":"sunt","note":"repellendus","cheque_number":"animi","bank_account_number":"et"}]}'
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/perferendis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":13,"transaction_date":"2020-5-7 15:20:22","invoice_no":"quasi","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":5,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":15,"shipping_status":"ordered","delivered_to":"voluptatem"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=necessitatibus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"provident","first_name":"consequuntur","last_name":"aliquid","email":"eos","is_active":"quis","user_type":"et","crm_contact_id":14,"allow_login":true,"username":"est","password":"consequatur","role":3,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"dolores","max_sales_discount_percent":"sequi","selected_contacts":false,"selected_contact_ids":[],"dob":"et","gender":"quasi","marital_status":"quod","blood_group":"numquam","contact_number":"nisi","alt_number":"animi","family_number":"similique","fb_link":"ea","twitter_link":"dignissimos","social_media_1":"blanditiis","social_media_2":"magni","custom_field_1":"est","custom_field_2":"cum","custom_field_3":"id","custom_field_4":"neque","guardian_name":"illo","id_proof_name":"odit","id_proof_number":"minus","permanent_address":"aperiam","current_address":"voluptatem","bank_details":[{"account_holder_name":"aliquam","account_number":"consequatur","bank_name":"animi","bank_code":"unde","branch":"voluptatem","tax_payer_id":"repellendus"}]}'
...
let body = {
    ...
    "cmmsn_percent": "dolores",
    "max_sales_discount_percent": "sequi",
    ...
    "contact_number": "nisi",
    "alt_number": "animi",
    "family_number": "similique",
    "fb_link": "ea",
    "twitter_link": "dignissimos",
    "social_media_1": "blanditiis",
    "social_media_2": "magni",
    "custom_field_1": "est",
    "custom_field_2": "cum",
    "custom_field_3": "id",
    "custom_field_4": "neque",
    "guardian_name": "illo",
    "id_proof_name": "odit",
    "id_proof_number": "minus",
    "permanent_address": "aperiam",
    "current_address": "voluptatem",
    "bank_details": [
        {
            "account_holder_name": "aliquam",
            "account_number": "consequatur",
            "bank_name": "animi",
            "bank_code": "unde",
            "branch": "voluptatem",
            "tax_payer_id": "repellendus"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=molestiae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"voluptatem","new_password":"voluptas"}'
